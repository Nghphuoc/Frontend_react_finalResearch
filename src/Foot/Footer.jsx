  ...
  return (
    <div className="bg-gray-100 shadow-sm pt-20">
      ...
      <div className="flex justify-center items-center  mt-10 h-32 relative z-10">
        <div className="bg-gray-500  w-1/2 max-w-lg text-white text-center py-8 px-6 shadow-lg rounded-lg">
      ...
      {/* Footer Section */}
      <footer className="bg-gray-500 text-white py-16 mt-0 relative z-0 text-xl">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 text-center md:text-left">
            <div>
              <h3 className="text-white font-bold">COLORLIB</h3>
            ...
            <div>
              <h3 className="text-white font-bold">Further Information</h3>
              <ul className="mt-2 space-y-1">
